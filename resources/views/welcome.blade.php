...
<div id="">
    <nav class="navbar navbar-light bg-success justify-content-between">
        <spam class="navbar-brand" style="color: white">Mi <img style='width:50px; height:50px;' src="images/Logo/Logo.png"></spam>
        <form class="form-inline">
			 <a class="navbar-brand" style="color: white" href="../public/login">Login</a>
			 <a class="navbar-brand" style="color: white" href="../public/register">Register</a>
